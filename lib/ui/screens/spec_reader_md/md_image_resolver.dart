...
/// viewport so badly that the user reads "only images, no text." 364
/// canonical px ≈ 1130 physical px on the tablet (~57% of viewport
/// height), leaving room for surrounding markdown text on the same
/// scroll position while keeping mockup details legible.
const double _kImageMaxHeight = 364;
